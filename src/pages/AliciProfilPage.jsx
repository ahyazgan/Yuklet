...
import { BadgeCheck, Star, MapPin, Globe, Building2, Briefcase, ShieldCheck, ArrowLeft, MessageCircle } from "lucide-react";
...
export default function AliciProfilPage({ user, users = [], listings = [], reviews = [], getUserRating }) {
  const { id } = useParams();
