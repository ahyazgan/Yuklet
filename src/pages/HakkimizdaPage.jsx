  ...
  return (
    <div className="mx-auto w-full max-w-5xl px-5 py-8 text-slate-900">
      ...
      <div className="mb-9 text-center">
        ...
        <h1 className="mt-3 text-3xl font-black tracking-tight text-slate-950">Hakkımızda</h1>
      </div>

      <div className="grid gap-5 lg:grid-cols-2">
        <div className="rounded-3xl bg-white p-7 shadow-sm">
          <h2 className="mb-3 text-xl font-extrabold tracking-tight text-slate-950">Misyonumuz</h2>
          ...
          <h2 className="mb-3 mt-8 text-xl font-extrabold tracking-tight text-slate-950">Vizyonumuz</h2>
          <p className="text-sm leading-relaxed text-gray-500">
        ...
        <div className="flex flex-col gap-3">
          {[
            ...
            <div key={title} className="flex items-start gap-3.5 rounded-3xl bg-white p-5 shadow-sm">
              <div className="flex h-11 w-11 flex-shrink-0 items-center justify-center rounded-2xl bg-slate-100 text-xl">{icon}</div>
              <div>
      ...
      {/* Rakamlar */}
      <div className="mt-12">
        <h2 className="mb-5 text-center text-xl font-extrabold tracking-tight text-slate-950">Rakamlarla HamTed</h2>
        <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-6">
          {[
            ...
            <div key={label} className="rounded-3xl bg-white p-5 text-center shadow-sm">
              <div className="text-2xl font-black tracking-tight text-slate-950">{num}</div>
