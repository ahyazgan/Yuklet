import { Truck, Users, Wrench, Megaphone } from "lucide-react";
...
export const MOLA_CATS = [
  { id: "dorse", label: "Satılık Dorse/Araç", short: "Dorse", Icon: Truck },
...
export const catOf = (id) => MOLA_CATS.find((c) => c.id === id) || MOLA_CATS[3];
