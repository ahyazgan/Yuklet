...
const ALICI = { id: "u-ss-alici", name: "Ertuğrul İnşaat", email: "demo@yuklet.co", role: "isveren", phone: "0532 000 00 01", verified: true, rating: 4.9, sehir: "İstanbul", ilce: "Ümraniye", firmaTuru: "İnşaat şirketi" };
const NAKLIYECI = { id: "u-ss-nak", name: "Demiroğlu Nakliyat", email: "demiroglu@yuklet.co", role: "nakliyeci", phone: "0532 000 00 02", verified: true, rating: 4.9, sehir: "Bursa", ilce: "Nilüfer", tasimaTuru: "Hafriyat + Silobas (ikisi)", filoOzeti: "6 araç · 18–30 ton · damperli + silobas", hizmetBolgeleri: ["İstanbul", "Kocaeli", "Bursa", "Sakarya", "İzmir"], hakkinda: "15 yıldır Marmara hattında hafriyat ve dökme yük taşıyoruz. K1 belgeli araçlar, deneyimli şoför kadrosu, zamanında teslim." };
const SATICI = { id: "u-ss-satici", name: "Akdağ Madencilik", email: "akdag@yuklet.co", role: "tedarikci", phone: "0532 000 00 03", verified: true, rating: 4.8, sehir: "Kocaeli", ilce: "Gebze", tesisTuru: "Kırma ocağı (taş/mıcır)", calismaSaatleri: "Hafta içi 07:30–18:30, Cmt 08:00–14:00", malzemeler: ["Mıcır (8–16 mm)", "Mıcır (16–32 mm)", "Çakıl (3–8 mm)", "Kum (0–3 mm)", "Kırma taş (agrega)"], hakkinda: "Marmara bölgesinde 20 yıldır faaliyet gösteren kırma taş ocağı. Kapasite raporu ve TSE belgeleri mevcut, nakliyeli teslim yapılır." };

const L = [
  // Alıcının işleri (ana sayfa "AKTİF İŞİM" + künye)
  // TUTARLILIK KURALI: varış ili = boşaltma noktasının GERÇEK ili; fiyatlar demo
  // için MAKUL bantta tutulur (₺4.5k–15k): küçük tonajlı işler, korkutucu toplam yok.
  { id: "9101", type: "is", cat: "hafriyat", title: "Şantiye kazı hafriyatı — 250 ton", il: "İstanbul", ilce: "Ümraniye", varisIl: "İstanbul", yukleme: "Dudullu OSB şantiyesi", bosaltma: "Kemerburgaz döküm sahası", material: "Toprak (kazı)", amount: 250, unit: "ton", dateText: "Bu hafta", priceType: "sabit", price: 15000, owner: "Ertuğrul İnşaat", ownerId: "u-ss-alici", ownerVerified: true, ownerRating: 4.9, status: "eslesti", offers: 0, createdText: "2 saat önce", recurring: true, recurringFreq: "gunluk", dailyTrips: 5, recurringText: "Her gün • Günde 5 sefer" },
  { id: "9102", type: "is", cat: "silobas", title: "Dökme çimento taşıma — santral besleme", il: "İstanbul", ilce: "Tuzla", varisIl: "Kocaeli", yukleme: "Tuzla çimento terminali", bosaltma: "Gebze beton santrali", material: "Çimento (dökme)", amount: 28, unit: "ton", dateText: "8-12 Temmuz", priceType: "sabit", price: 12500, owner: "Ertuğrul İnşaat", ownerId: "u-ss-alici", ownerVerified: true, ownerRating: 4.9, status: "aktif", offers: 0, createdText: "5 saat önce" },
  // Tamamlanmış işler (ana sayfa "TAMAMLANAN" istatistiği dolu görünsün)
  { id: "9103", type: "is", cat: "hafriyat", title: "Bahçelievler temel kazısı — 100 ton", il: "İstanbul", ilce: "Bahçelievler", material: "Toprak (kazı)", amount: 100, unit: "ton", priceType: "sabit", price: 7500, owner: "Ertuğrul İnşaat", ownerId: "u-ss-alici", ownerVerified: true, ownerRating: 4.9, status: "kapali", offers: 0, createdText: "geçen ay" },
  { id: "9104", type: "is", cat: "hafriyat", title: "Moloz nakliyesi — dönüşüm sahası", il: "İstanbul", ilce: "Kadıköy", material: "Yıkıntı molozi", amount: 120, unit: "ton", priceType: "sabit", price: 9000, owner: "Ertuğrul İnşaat", ownerId: "u-ss-alici", ownerVerified: true, ownerRating: 4.9, status: "kapali", offers: 0, createdText: "geçen ay" },
  // Satıcının ürün kataloğu (vitrin)
  { id: "9201", type: "urun", cat: "silobas", title: "Yıkanmış kum (0–3 mm)", il: "Kocaeli", ilce: "Gebze", material: "Kum (0–3 mm)", priceType: "sabit", price: 520, priceUnit: "₺/ton", stock: "bol", stockText: "Bol stok", deliveryIncluded: true, desc: "Elenmiş, yıkanmış inşaat kumu.", owner: "Akdağ Madencilik", ownerId: "u-ss-satici", ownerVerified: true, ownerRating: 4.8, status: "aktif", offers: 0, createdText: "1 gün önce" },
  { id: "9202", type: "urun", cat: "silobas", title: "Mıcır (16–32 mm) — ocak teslim", il: "Kocaeli", ilce: "Gebze", material: "Mıcır (16–32 mm)", priceType: "sabit", price: 480, priceUnit: "₺/ton", stock: "orta", stockText: "Orta stok", deliveryIncluded: false, owner: "Akdağ Madencilik", ownerId: "u-ss-satici", ownerVerified: true, ownerRating: 4.8, status: "aktif", offers: 0, createdText: "2 gün önce" },
  { id: "9203", type: "urun", cat: "silobas", title: "Kırma taş agrega — beton sınıfı", il: "Kocaeli", ilce: "Gebze", material: "Kırma taş (agrega)", priceType: "sabit", price: 445, priceUnit: "₺/ton", stock: "bol", stockText: "Bol stok", deliveryIncluded: true, owner: "Akdağ Madencilik", ownerId: "u-ss-satici", ownerVerified: true, ownerRating: 4.8, status: "aktif", offers: 0, createdText: "3 gün önce" },
  // Nakliyecinin araç ilanları (profil + pano)
  { id: "9301", type: "arac", cat: "hafriyat", title: "Damperli kamyon boşta — 25 ton", il: "İstanbul", ilce: "Tuzla", vehicle: "Damperli kamyon (20–25 t)", capacity: "25 ton", dateText: "Hemen", priceType: "sabit", price: 12000, owner: "Demiroğlu Nakliyat", ownerId: "u-ss-nak", ownerVerified: true, ownerRating: 4.9, status: "aktif", offers: 0, createdText: "30 dk önce" },
  { id: "9302", type: "arac", cat: "silobas", title: "Silobas araç — çimento/dökme yük", il: "Kocaeli", ilce: "Gebze", vehicle: "Silobas (çimento)", capacity: "28 ton", dateText: "Yarından itibaren", priceType: "sabit", price: 12500, owner: "Demiroğlu Nakliyat", ownerId: "u-ss-nak", ownerVerified: true, ownerRating: 4.9, status: "aktif", offers: 0, createdText: "1 saat önce" },
];
...
const SHOTS = [
  { file: "01-ana-sayfa", path: "/", user: ALICI, waitText: "Merhaba, Ertuğrul İnşaat" },
