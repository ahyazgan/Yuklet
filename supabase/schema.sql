...
select * from (values
  ('Yildizlar Insaat', true, 4.7::numeric, 'is','hafriyat','Dudullu santiye hafriyat tasima','Istanbul','Umraniye','Dudullu OSB, blok C insaati','Samandira dokum sahasi','Hafriyat toprağı (kazı)',1200::numeric,'ton','8-12 Haziran',true,'5 gun, gunde ~20 sefer',null::text,null::text,'teklif',null::numeric,'Bina kazisi cikan hafriyat. Yukleme makinesi sahada mevcut. Tasima mesafesi ~14 km.','aktif',0,'2 saat once'),
  ('Cayirova Yapi', true, 4.5, 'is','silobas','Cimento fabrikasindan santiyeye dokme cimento','Kocaeli','Gebze','Nuh Cimento fabrika','Cayirova konut projesi','Çimento (dökme)',28,'ton','3 Haziran (acil)',false,'',null,null,'sabit',4500,'Tek sefer dokme cimento tasima. Silobas zorunlu. Bosaltma sahada silo var.','aktif',0,'5 saat once'),
  ...
  ('Baskent Altyapi', true, 4.6, 'is','hafriyat','Yol genisletme - kazi fazlasi tasima','Ankara','Etimesgut','Eryaman yol calismasi','Belediye dokum alani','Hafriyat toprağı (kazı)',800,'m³','10-15 Haziran',true,'Yaklasik 1 hafta',null,null,'teklif',null,'Yol genisletmeden cikan toprak. Birden fazla araca ihtiyac var.','aktif',0,'3 saat once'),
  ('Ege Lojistik', true, 4.4, 'is','hafriyat','Limandan fabrikaya micir tasima','Izmir','Aliaga','Aliaga limani','Kemalpasa sanayi','Mıcır 2 no (12-22 mm)',120,'ton','7-9 Haziran',false,'',null,null,'teklif',null,'Limandan bosaltilan micir, fabrikaya tasinacak. Damperli kamyon uygun.','aktif',0,'6 saat once')
) as v
